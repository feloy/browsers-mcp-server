...
const BINARY_MAP = {
  darwin_x64: {name: 'browsers-mcp-server-darwin-amd64', suffix: ''},
  darwin_arm64: {name: 'browsers-mcp-server-darwin-arm64', suffix: ''},
  linux_x64: {name: 'browsers-mcp-server-linux-amd64', suffix: ''},
  linux_arm64: {name: 'browsers-mcp-server-linux-arm64', suffix: ''},
  win32_x64: {name: 'browsers-mcp-server-windows-amd64', suffix: '.exe'},
  win32_arm64: {name: 'browsers-mcp-server-windows-arm64', suffix: '.exe'},
};
